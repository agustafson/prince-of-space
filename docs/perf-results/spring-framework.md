...
|-----------|-----------|-----------|----------|
| Prince of Space (strict, fixed-point) | 59 s | 6.47 | 0 |
| Prince of Space (fast, single pass) | 24 s | 2.65 | 0 |
| Google Java Format (AOSP) | 26 s | 2.93 | 0 |
| Palantir Java Format (AOSP) | 26 s | 2.87 | 0 |
