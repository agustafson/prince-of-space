...
All examples use the `java17` input from [`examples/inputs/java17/FormatterShowcase.java`](https://github.com/prince-of-space/prince-of-space/blob/main/examples/inputs/java17/FormatterShowcase.java).
The full set of 48 golden outputs lives in the [`examples/outputs/`](https://github.com/prince-of-space/prince-of-space/tree/main/examples/outputs) directory.
