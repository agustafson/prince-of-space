...
|-----------|-----------|-----------|----------|
| Prince of Space (strict, fixed-point) | 57 s | 6.26 | 0 |
| Prince of Space (fast, single pass) | 23 s | 2.53 | 0 |
| Google Java Format (AOSP) | 25 s | 2.72 | 0 |
| Palantir Java Format (AOSP) | 24 s | 2.66 | 0 |
